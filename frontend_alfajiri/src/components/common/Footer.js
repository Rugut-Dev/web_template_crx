...
const Footer = () => {
	return (
		<div style={{ background: 'linear-gradient(to left, #DEECFF, white)' }}>
		<div className='m-auto text-black p-6 flex justify-center items-center'>
			<div className='grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 lg:gap-10'>
			<div className='py-2'>
				<div className='pb-2'>
					<img src="./alfajirilogo.jpeg" alt='Alfajiri Logo' className="h-30 w-40 rounded" />
				</div>
		...
		<div className="">
			<div className="container border-t-[1px] border-black m-auto py-4 text-center text-black">
			<small className='font-bold'>&copy; 2024 Alfajiri Systems Limited All Rights Reserved</small>
			</div>
		</div>
		</div>
	)
